...
if ( ! function_exists( 'qi_render_button_element' ) ) {
	...
	function qi_render_button_element( $params ) {
		...
		echo qi_get_button_element( $params );
	}
}
...
if ( ! function_exists( 'qi_class_attribute' ) ) {
	...
	function qi_class_attribute( $class ) {
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		echo qi_get_class_attribute( $class );
	}
}
...
if ( ! function_exists( 'qi_render_svg_icon' ) ) {
	...
	function qi_render_svg_icon( $name, $class_name = '' ) {
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		echo qi_get_svg_icon( $name, $class_name );
	}
}
	...
	function qi_get_svg_icon( $name, $class_name = '' ) {
		...
		switch ( $name ) {
			case 'menu':
				...
				break;
			case 'search':
				$html = '<svg ' . $class . ' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18.7px" height="19px" viewBox="0 0 18.7 19" xml:space="preserve"><g><path d="M11.1,15.2c-4.2,0-7.6-3.4-7.6-7.6S6.9,0,11.1,0s7.6,3.4,7.6,7.6S15.3,15.2,11.1,15.2z M11.1,1.4c-3.4,0-6.2,2.8-6.2,6.2s2.8,6.2,6.2,6.2s6.2-2.8,6.2-6.2S14.5,1.4,11.1,1.4z"/></g><g><rect x="-0.7" y="14.8" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -9.9871 6.9931)" width="8.3" height="1.4"/></g></svg>';
				break;
			case 'plus':
			...
			case 'menu-arrow-left':
				$html = '<svg ' . $class . ' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="6.2px" height="10.8px" viewBox="0 0 6.2 10.8" xml:space="preserve"><g><path d="M0,5.4C0,5.2,0.1,5,0.2,4.9l4.7-4.7c0.3-0.3,0.7-0.3,1,0c0.3,0.3,0.3,0.7,0,1L1.8,5.4l4.1,4.2C6,9.7,6.1,9.9,6.1,10.1c0,0.2-0.1,0.4-0.2,0.5c-0.3,0.3-0.7,0.3-1,0L0.2,5.9C0.1,5.8,0,5.6,0,5.4z"/></g></svg>';
				break;
			case 'menu-arrow-right':
				$html = '<svg ' . $class . ' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="6.2px" height="10.8px" viewBox="0 0 6.2 10.8" xml:space="preserve" aria-hidden="true"><g><path d="M5.9,5.9l-4.7,4.7c-0.3,0.3-0.7,0.3-1,0c-0.1-0.1-0.2-0.3-0.2-0.5c0-0.2,0.1-0.4,0.2-0.5l4.1-4.2L0.3,1.2c-0.4-0.3-0.4-0.7,0-1c0.3-0.3,0.7-0.3,1,0l4.7,4.7C6.1,5,6.2,5.2,6.2,5.4C6.2,5.6,6.1,5.8,5.9,5.9z"/></g></svg>';
				break;
			...
			case 'slider-arrow-left':
				$html = '<svg ' . $class . ' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="21px" height="12.4px" viewBox="0 0 21 12.4" xml:space="preserve" style="stroke: none;"><g><path d="M0,6.2C0,6.1,0,6,0.1,5.9c0-0.1,0.1-0.2,0.2-0.3l5.3-5.3c0.4-0.4,0.8-0.4,1.2,0c0.4,0.4,0.4,0.8,0,1.2L3,5.3h17.1c0.3,0,0.5,0.1,0.6,0.2S21,5.9,21,6.2c0,0.3-0.1,0.5-0.2,0.6s-0.4,0.2-0.6,0.2H3l3.7,3.8c0.4,0.4,0.4,0.8,0,1.2c-0.4,0.4-0.8,0.4-1.2,0L0.3,6.8C0.2,6.7,0.1,6.6,0.1,6.5C0,6.4,0,6.3,0,6.2z"/></g></svg>';
				break;
			case 'slider-arrow-right':
				$html = '<svg ' . $class . ' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="21px" height="12.4px" viewBox="0 0 21 12.4" xml:space="preserve" style="stroke: none;"><g><path d="M20.9,6.5c0,0.1-0.1,0.2-0.2,0.3L15.5,12c-0.4,0.4-0.8,0.4-1.2,0c-0.4-0.4-0.4-0.8,0-1.2L18,7.1H0.9C0.6,7.1,0.4,7,0.2,6.8S0,6.4,0,6.2c0-0.3,0.1-0.5,0.2-0.6s0.4-0.2,0.6-0.2H18l-3.7-3.8c-0.4-0.4-0.4-0.8,0-1.2c0.4-0.4,0.8-0.4,1.2,0l5.3,5.3c0.1,0.1,0.2,0.2,0.2,0.3C21,6,21,6.1,21,6.2S21,6.4,20.9,6.5z"/></g></svg>';
				break;
			case 'pagination-arrow-left':
				$html = '<svg ' . $class . ' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="6.2px" height="10.8px" viewBox="0 0 6.2 10.8" xml:space="preserve" style="stroke: none;"><g><path d="M0,5.4C0,5.2,0.1,5,0.2,4.9l4.7-4.7c0.3-0.3,0.7-0.3,1,0c0.3,0.3,0.3,0.7,0,1L1.8,5.4l4.1,4.2C6,9.7,6.1,9.9,6.1,10.1c0,0.2-0.1,0.4-0.2,0.5c-0.3,0.3-0.7,0.3-1,0L0.2,5.9C0.1,5.8,0,5.6,0,5.4z"/></g></svg>';
				break;
			case 'pagination-arrow-right':
				$html = '<svg ' . $class . ' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="6.2px" height="10.8px" viewBox="0 0 6.2 10.8" xml:space="preserve" style="stroke: none;"><g><path d="M5.9,5.9l-4.7,4.7c-0.3,0.3-0.7,0.3-1,0c-0.1-0.1-0.2-0.3-0.2-0.5c0-0.2,0.1-0.4,0.2-0.5l4.1-4.2L0.3,1.2c-0.4-0.3-0.4-0.7,0-1c0.3-0.3,0.7-0.3,1,0l4.7,4.7C6.1,5,6.2,5.2,6.2,5.4C6.2,5.6,6.1,5.8,5.9,5.9z"/></g></svg>';
				break;
			case 'pagination-burger':
				$html = '<svg ' . $class . ' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 18 18" xml:space="preserve"><rect x="11" width="7" height="7"/><rect x="11" y="11" width="7" height="7"/><rect width="7" height="7"/><rect y="11" width="7" height="7"/></>';
				break;
			case 'spinner':
