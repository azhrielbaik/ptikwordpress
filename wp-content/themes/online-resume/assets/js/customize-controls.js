( function( $ ) {
  var this_obj = onlineresume_customizer_params;
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'onlineresume_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'onlineresume_panel' !== panel.params.type ||
  ...
  wp.customize.Panel = wp.customize.Panel.extend({
    attachEvents: function() {
      ...
      if (
        'onlineresume_panel' !== this.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      if (
        'onlineresume_section' !== this.params.type ||
...
(function (api) {
  ...
  api.Tab = api.Control.extend({
    ready: function () {
      var control = this;
      control.container.find('a.onlineresume-customizer-tab').click(function (evt) {
        var tab = jQuery(this).data('tab');
        evt.preventDefault();
        control.container.find('a.onlineresume-customizer-tab').removeClass('active');
...
jQuery( document ).ready(function($) {
  ...
  $('.refresh-btn').on('click', function() {
    ...
    $.get( onlineresume_customizer_params.ajaxurl + '?action=' + dataValue, function( data ) {
