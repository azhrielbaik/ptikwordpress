...
add_action( 'customize_controls_enqueue_scripts', function() {
	...
	wp_enqueue_script(
		'onlineresume-customize-section-button',
	...
	wp_localize_script(
		'onlineresume-customize-section-button',
		'onlineresume_customizer_params',
		array( 
 ...
 */
function online_resume_scripts() {
	...
	wp_enqueue_style('onlineresume-editor-style',get_template_directory_uri().'/assets/css/editor-style.css');

	wp_enqueue_style('onlineresume-main', get_template_directory_uri() . '/assets/css/main.css');
	
	wp_enqueue_style('onlineresume-woo', get_template_directory_uri() . '/assets/css/woo.css');
	
	wp_enqueue_style( 'onlineresume-style', get_stylesheet_uri() );
	...
	wp_enqueue_script('onlineresume-custom-js', get_template_directory_uri() . '/assets/js/theme.js', array('jquery'), false, true);

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'online_resume_scripts' );
