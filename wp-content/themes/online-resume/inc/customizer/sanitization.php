 ...
 */
function onlineresume_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function onlineresume_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function onlineresume_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function onlineresume_sanitize_float( $input ) {
 ...
 */
function onlineresume_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function onlineresume_sanitize_html( $html ) {
 ...
 */
function onlineresume_sanitize_image( $image, $setting ) {
 ...
 */
function onlineresume_sanitize_nohtml( $nohtml ) {
 ...
 */
function onlineresume_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function onlineresume_sanitize_range_value( $number, $setting ) {
 ...
 */
function onlineresume_sanitize_select( $input, $setting ) {
 ...
 */
function onlineresume_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function onlineresume_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function onlineresume_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
